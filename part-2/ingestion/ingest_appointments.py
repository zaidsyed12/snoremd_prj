"""
Ingests appointments.json -> RAW.APPOINTMENTS
...
class AppointmentsIngester(BaseIngester):
    TABLE = "APPOINTMENTS"

    def __init__(self):
        super().__init__("ingest_appointments")
    ...
    def extract(self, file_path: str) -> pd.DataFrame:
        ...
        # Drop any columns not in RAW.APPOINTMENTS schema
...
if __name__ == "__main__":
    ...
    AppointmentsIngester().run(str(Path(__file__).parent.parent / "data/raw/appointments.json"))
